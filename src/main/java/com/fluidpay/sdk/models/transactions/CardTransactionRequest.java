...
/**
 * Request to process a card transaction.
 * Supports all transaction fields as documented in the Fluidpay API.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class CardTransactionRequest implements TransactionRequest{
    private String type;
    ...
    private CardPayment paymentMethod;
    ...
    public CardTransactionRequest(String type, int amount, boolean taxExempt, int taxAmount, int shippingAmount, String currency, String description, String orderId, String poNumber, String ipAddress, boolean emailReciept, String emailAddress, CardPayment paymentMethod, Address billingAddress, Address shippingAddress) {
        this.type = type;
        this.amount = amount;
    ...
    public Boolean getCreateVaultRecord() {
        return createVaultRecord;
    }

    public void setCreateVaultRecord(Boolean createVaultRecord) {
        this.createVaultRecord = createVaultRecord;
    }

    public String getCreateVaultRecordFor() {
        return createVaultRecordFor;
    }

    public void setCreateVaultRecordFor(String createVaultRecordFor) {
        this.createVaultRecordFor = createVaultRecordFor;
    }
    ...
    public CardPayment getPaymentMethod() {
        return paymentMethod;
    }

    public void setPaymentMethod(CardPayment paymentMethod) {
        this.paymentMethod = paymentMethod;
    }
    ...
    public void setProcessorSpecific(ProcessorSpecific processorSpecific) {
    ...
    public String getIiasStatus() {
        return iiasStatus;
    }

    public void setIiasStatus(String iiasStatus) {
        this.iiasStatus = iiasStatus;
    }
    ...
    public String getCardOnFileIndicator() {
        return cardOnFileIndicator;
    }

    public void setCardOnFileIndicator(String cardOnFileIndicator) {
    ...
    public void setStoredCredentialIndicator(String storedCredentialIndicator) {
        this.storedCredentialIndicator = storedCredentialIndicator;
    }

    public Integer getSplitTransactionAmount() {
        return splitTransactionAmount;
    }

    public void setSplitTransactionAmount(Integer splitTransactionAmount) {
        this.splitTransactionAmount = splitTransactionAmount;
    }
    ...
    public Integer getIdempotencyTime() {
        return idempotencyTime;
    }

    public void setIdempotencyTime(Integer idempotencyTime) {
