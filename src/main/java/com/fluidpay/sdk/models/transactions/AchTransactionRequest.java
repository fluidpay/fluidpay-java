...
/**
 * Request to process an ACH transaction.
...
public class AchTransactionRequest implements TransactionRequest{
    ...
    public AchPayment getPaymentMethod() { return paymentMethod; }
    public void setPaymentMethod(AchPayment paymentMethod) { this.paymentMethod = paymentMethod; }
