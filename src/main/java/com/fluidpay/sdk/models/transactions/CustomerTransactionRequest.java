...
/**
 * Request to process a customer transaction using a vaulted customer record.
 * Supports all transaction fields as documented in the Fluidpay API.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class CustomerTransactionRequest implements TransactionRequest{
    private String type;
    ...
    private CustomerPayment paymentMethod;
    ...
    public CustomerTransactionRequest(String type, int amount, boolean taxExempt, int taxAmount, int shippingAmount, String currency, String description, String orderId, String poNumber, String ipAddress, boolean emailReciept, String emailAddress, CustomerPayment paymentMethod, Address billingAddress, Address shippingAddress) {
        this.type = type;
        this.amount = amount;
    ...
    public CustomerPayment getPaymentMethod() { return paymentMethod; }
    public void setPaymentMethod(CustomerPayment paymentMethod) { this.paymentMethod = paymentMethod; }
